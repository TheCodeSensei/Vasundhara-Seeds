        ...
        <div >
            <footer class="bg-green-800 text-white py-10">
                <div class="container mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-10">
                    ...
                    {/* <!-- Logo & About --> */}
                    <div>
                        <img src='/logo_hindi.jpeg' className='h-[50px] cursor-pointer rounded-full' onClick={() => window.location.href = '/'} /><br></br>
                    ...
                    {/* <!-- Quick Links --> */}
                    <div>
                        <h3 class="text-lg font-semibold mb-4 border-b-2 border-yellow-500">Quick Links</h3>
                    ...
                    {/* <!-- Contact Info --> */}
                    <div>
                        <h3 className="text-lg font-semibold mb-4 border-b-2 border-yellow-500">Connect With Us</h3>
                        <img src='/map.png'></img><p class="text-gray-300 text-sm">53 D Badi Udyogpuri, Maxi Rd, near Mahaveer Toll Kata, Agrasen Nagar, Ujjain, Madhya Pradesh 456010</p>
                        <img src='/email.png'></img><p class="text-gray-300 text-sm">vasundharabio@yahoo.co.in</p>
                        <img src='/phone.png'></img><p class="text-gray-300 text-sm">+91 9425332127</p>
                    </div>

                    {/* <!-- Social Media --> */}
                    <div>
                        <h3 className="text-lg font-semibold mb-4 border-b-2 border-yellow-500">Join our Social Networks</h3>
