...
export default function About(){
    ...
    const teamMembers = [
      ...
      const certifications = [
        { name: "ISO 9001", image: "/cert1.png" },
        { name: "Certified AI Expert", image: "/cert2.png" },
        { name: "Cyber Security Certified", image: "/cert3.png" },
        { name: "Best Tech Company 2024", image: "/cert4.png" },
      ];
    ...
    <div class="mt-8 text-center">
      ...
      <div class="mt-4 grid grid-cols-1 md:grid-cols-3 gap-6">
        <div class="p-4 bg-white shadow rounded-lg border border-green-800">
          <h4 class="text-2xl font-bold text-green-900">1000+</h4>
...
<section className="bg-gray-100 py-12 px-6">
      ...
      <div className="container mx-auto text-center mt-12">
        ...
        <p className="text-gray-600 mb-6">Recognized by top organizations worldwide</p>
        
        <div className="flex flex-wrap justify-center gap-6">
          {certifications.map((cert, index) => (
            <div key={index} className="bg-white p-4 rounded-xl shadow-md">
              <img src={cert.image} alt={cert.name} className="w-32 h-32 mx-auto object-contain" />
              <p className="text-gray-700 font-semibold mt-2">{cert.name}</p>
            </div>
          ))}
        </div>
      </div>
