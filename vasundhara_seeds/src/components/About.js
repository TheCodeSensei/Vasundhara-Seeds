    ...
    <div>
      ...
      <section className="relative bg-cover bg-center h-[400px] pt-1">
        ...
        <div
          ...
          style={{ backgroundImage: `url('/field1.JPG')` }}
        >
      ...
      {/* About Section */}
      <section class="p-6 md:p-10 bg-white ">
      ...
      <section className="bg-gray-200 px-6">
        <div className="container mx-auto text-center">
         <div className="flex justify-center"><h2 className="text-3xl font-bold text-gray-800 border-b-2 border-yellow-900">Awards</h2></div> 
