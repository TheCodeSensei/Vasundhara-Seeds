...
export default function Navbar() {
  ...
  return (
    <div>
      {/* Navbar */}
      <header className=" bg-white text-black p-4 md:h-20 lg:h-15 fixed top-0 left-0 w-full z-50 shadow-md">
        <div className="container mx-auto flex justify-between items-center ">
          <img src='/logo_hindi.jpeg' className='cursor-pointer w-40
          ...
          <div className="hidden md:flex items-center bg-gray-100 px-3 py-1 rounded-full shadow-inner">
          ...
          {/* Nav Bar */}
          <nav
            className={`absolute md:relative top-full left-0 md:top-0 w-full md:w-auto bg-white md:bg-transparent shadow-md md:shadow-none transition-all ease-in-out duration-300 z-50 ${isMenuOpen ? "block" : "hidden"
      ...
      <div className="w-full h-[2px] bg-yellow-900 fixed top-20 left-0 z-50"></div>



      {/* WhatsApp button */}
      <a
        href="https://wa.me/9425332127"
